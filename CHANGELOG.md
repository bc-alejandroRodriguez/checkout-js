...
### [1.233.1-prerelease.1660250832279](https://github.com/bigcommerce/checkout-js/compare/v1.233.0...v1.233.1-prerelease.1660250832279) (2022-08-11)
...
* **payment:** INT-5854 [Mollie] Some comments solved ([3d05ba9](https://github.com/bigcommerce/checkout-js/commit/3d05ba9803f99cd4df863a79de7c59a97191ff5d))
* **payment:** INT-5854 [Mollie] Test fixed ([e7d0e34](https://github.com/bigcommerce/checkout-js/commit/e7d0e34ab21f95f18dbf653f83d484cc5930f837))
* **payment:** INT-6392 [Mollie] Shopper are able to place orders with Digital items through Klarna Pay Later and Slice it when them are added via coupon ([c29d240](https://github.com/bigcommerce/checkout-js/commit/c29d24056a569265ec6a1f19faea151a41fc2d2b))
